...
source(paste(repmaster,"Docs_web/F_importparametres.R",sep="")) # Ne pas modifier, chargement de la fonction
importparametres(repmaster=repmaster,dsn=dsn) # Ne pas modifier, lancement de la fonction pour générer l'ensemble des paramètres
