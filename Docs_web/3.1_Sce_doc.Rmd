---
title: "Etape 1 : Collecte et stockage des données brutes de DOC (Dissolved Organic Carbon)"
---
...
<div class="alert alert-success" role="alert">
  ...
  <p>Décrire la collecte et le stockage des données brutes DOC (Dissolved Organic Carbon) à l'exutoire de la tourbière. Ces données brutes sont nommées `Brute_doc`</p>
</div>
