...
## Se connecter au serveur `163.9.41.45` :
...
cp -r ~/devel/prod/Developpement/SI/app_shiny/snapshot/module/* /srv/shiny-server/data-access/
# data-access en développement
cp -r ~/devel/prod/Developpement/SI/app_shiny/snapshot/module/* /srv/shiny-server/data-access-snapshot/
# dataset-archive en production
cp -r ~/devel/prod/Developpement/SI/app_shiny/snapshot/module/* /srv/shiny-server/dataset-archive/
```
...
```{r, engine = 'bash',class.source='klippy',eval=FALSE}
cp ~/devel/conf/confConnexion.R /srv/shiny-server/data-access/
cp ~/devel/conf/confConnexion.R /srv/shiny-server/data-access-snapshot/
cp ~/devel/conf/confConnexion.R /srv/shiny-server/dataset-archive/
```
