...
<div class="alert alert-info" role="alert">
  ...
  <p>Voici un exemple de fichier type `SNOT_doc` pour la station multiparamètre sm_exutoire de la Guette pour la période du 06-11-2008 au 16-04-2009 (données fictives) : `r linkAlertCSS("lgt-sm_exutoire_doc_infraj_06-11-2008_16-04-2009.csv","https://github.com/Rosalien/doc_snot/raw/master/Data/lgt/sm_exutoire/doc/3_SNOT_doc/lgt-sm_exutoire_doc_infraj_06-11-2008_16-04-2009.csv")`
  </p>
</div>
...
Il est recommandé de s'appuyer sur un exemple pour générer un fichier type `SNOT_doc` manuellement : 
  ...
  - [lgt-sm_exutoire_doc_infraj_06-11-2008_16-04-2009.csv](https://github.com/Rosalien/doc_snot/raw/master/Data/lgt/sm_exutoire/doc/3_SNOT_doc/lgt-sm_exutoire_doc_infraj_06-11-2008_16-04-2009.csv)
