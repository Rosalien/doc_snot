...
<div class="alert alert-success" role="alert">
  ...
  <p>Décrire le format de fichier pour intégrer le type de données `doc` dans l'application web du SI SNO-T : `r linkAlertCSS("data-snot.cnrs.fr","https://data-snot.cnrs.fr/")`. Ce type de fichier est nommé `SNOT_docpoc`</p>
</div>

<div class="alert alert-info" role="alert">
  <h4 class="alert-heading">**Exemple pour gagner du temps**</h4>
  <p>Voici un exemple de fichier type `SNOT_docpoc` pour la station multiparamètre sm_exutoire de la Guette pour la période du 06-11-2008 au 16-04-2009 (données fictives) : `r linkAlertCSS("lgt-sm_exutoire_doc_infraj_06-11-2008_16-04-2009.csv","https://github.com/Rosalien/doc_snot/raw/master/Data/lgt/sm_exutoire/doc/3_SNOT_docpoc/lgt-sm_exutoire_doc_infraj_06-11-2008_16-04-2009.csv")`
  </p>
</div>
...
Il est recommandé de s'appuyer sur un exemple pour générer un fichier type `SNOT_docpoc` manuellement : 
  ...
  - [lgt-sm_exutoire_doc_infraj_06-11-2008_16-04-2009.csv](https://github.com/Rosalien/doc_snot/raw/master/Data/lgt/sm_exutoire/doc/3_SNOT_docpoc/lgt-sm_exutoire_doc_infraj_06-11-2008_16-04-2009.csv)
