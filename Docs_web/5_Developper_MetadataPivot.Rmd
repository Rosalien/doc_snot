...
Le module de génération des métadonnées est accessible à cette [adresse](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/show/Developpement/SI/app_snot/PivotMetadata). Basé sur une implementation (jax-D) de services web REST avec JAX-RS, il permet la génération de métadonnées à la volée grâce à des requêtes curl.
...
- Les paramètres de connexion à la base de données sont gérés dans [Main.java](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/raw/Developpement/SI/app_snot/PivotMetadata/src/main/java/entry/Main.java).
- Les requêtes JPA ves la base de données sont dans [JPAQueryDAO.java](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/raw/Developpement/SI/app_snot/PivotMetadata/src/main/java/moulinette/jpa/JPAQueryDAO.java).
- Les constructeurs des 3 grandes parties de la métadonnée (Producer, Dataset, Observation) sont dans le [builder](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/show/Developpement/SI/app_snot/PivotMetadata/src/main/java/moulinette/builder).
- Les fichiers de description pour la partie `producer` sont dans le répertoire [inputs_files](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/show/Developpement/SI/app_snot/PivotMetadata/src/main/resources/inputs_files). Le fichier [Producer_snot.csv.csv](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/raw/Developpement/SI/app_snot/PivotMetadata/src/main/resources/inputs_files/Producer_snot.csv) décrit les producteurs du SNO-Tourbières.

# Fonctionnement général

## Lancement du module 
Le module est lancé dans le serveur `163.9.41.45` :
