---
title: "Etape 1 : Collecte et stockage des données brutes des piézomètres"
---
...
<div class="alert alert-success" role="alert">
  ...
  <p>Décrire la collecte et le stockage des données brutes en provenance des stations météo-sol. Ces données brutes sont nommées `Brute_piezo`</p>
</div>
...
Les Fichiers bruts en sortie des piézomètres sont stockés selon le chemin suivant :
