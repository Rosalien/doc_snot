...
# Le serveur 163.9.41.46

Le serveur 163.9.41.46 (**VM postgres**) héberge un serveur postgresQL contenant les bases de données associées aux applications en production et en développement :
...
Modifer listen_addresses = 'localhost,163.9.41.46'
...
```{r, engine = 'bash',class.source='klippy',eval=FALSE}
ssh -L 5437:localhost:5432 snotadmin@163.9.41.46
```
...
Pour le besoin de l'application [https://data-snot.cnrs.fr/data-access/](https://data-snot.cnrs.fr/data-access/), plusieurs vues matérialisées accompagnées de fonction trigger pour les mettre à jour ont été créées. Les scripts de création de ces vues sont accessibles ci-dessous :

- [MaterializedView_Prod.sql](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/raw/Developpement/SI/app_shiny/snapshot/module/sql/MaterializedView_Prod.sql) : Création des vues matérialisées
- [TriggerMaterializedView_Prod.sql](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/raw/Developpement/SI/app_shiny/snapshot/module/sql/TriggerMaterializedView_Prod.sql) : Fonction pour rafraichir la vue matérialisée `data_infraj_prod`
- [TriggerDebouncePeriod.sql](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/raw/Developpement/SI/app_shiny/snapshot/module/sql/TriggerDebouncePeriod.sql) : Ensemble des instructions pour rafraichir la vue matérialisée `carac_data_sensor_method_prod` avec un décalage de 10 minutes lorsque l'une des tables associées à la création de cette vue est mise à jour.
...
Le script de création des tables et des triggers est accessible [ici](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/raw/Developpement/SI/app_shiny/snapshot/module/sql/TriggerDebouncePeriod.sql).

[RefreshMaterializedView.sh](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/raw/Developpement/SI/app_shiny/snapshot/module/sql/RefreshMaterializedView.sh) est lancé toutes les minutes dans le crontab du serveur tomcat avec cette configuration :

```{r, engine = 'bash',class.source='klippy',eval=FALSE}
* * * * * tomcat /home/tomcat/devel/metadata/RefreshMaterializedView.sh
```
