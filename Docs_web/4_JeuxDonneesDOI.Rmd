...
On veillera à mettre à jour les champs de la table jeu.
Le champs DOI correspond au DOI de toutes les version du jeu de données. La citation correspond à la dernière citation de la version du jeu de données.
Ces éléments sont présentés sur Zenodo une fois le jeu de données publié : 
