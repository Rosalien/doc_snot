...
- [snot-core-services-api](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/show/Developpement/SI/app_snot/snot-core-services-api) : Implémentation des fonctionnalité du noyau du SI des SOERE, configuration des entités pour la base de données (contraintes, nom des champs...)
- [snot-core-services-impl](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/show/Developpement/SI/app/snot-core-services-impl) : JPA-DAO et recorder des données de référence et autres fonctionnalité du noyau.
- [snot-core-ui-jsf](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/show/Developpement/SI/app_snot/snot-core-ui-jsf) : Implémentation de l'inteface jsf/hibernate des fonctionnalités du noyau.
- [snot-fluxmeteo-services-api](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/show/Developpement/SI/app_snot/snot-fluxmeteo-services-api) : Implémentation des fonctionnalités d'intégration des données d'observation, configuration des tables d'intégration des données d'observation.
- [snot-fluxmeteo-services-impl](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/show/Developpement/SI/app_snot/snot-fluxmeteo-services-impl) : JPA-DAO,recorder et dataset-descriptor des données d'observation.
- [snot-fluxmeteo-ui-jsf](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/show/Developpement/SI/app_snot/snot-fluxmeteo-ui-jsf) : Implémentation de l'inteface jsf/hibernate des fonctionnalités du noyau pour l'intégration des données d'observation.
- [snot-web](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/show/Developpement/SI/app_snot/snot-web) : Contenu de l'application web (xhtml, css, configuration du thème primefaces...)

Les deux modules d'extraction ont été conservés mais ne sont pas utilisés : 

- [snot-fluxmeteo-extraction-impl](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/show/Developpement/SI/app_snot/snot-fluxmeteo-extraction-impl) : Implémentation des fonctionnalités d'extration pour tous les types de données.
- [snot-fluxmeteo-extraction-ui-jsf](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/show/Developpement/SI/app_snot/snot-fluxmeteo-extraction-ui-jsf) : Implémentation de l'inteface jsf/hibernate des fonctionnalités du noyau pour l'extraction des données.
...
<div class="alert alert-info" role="alert">
  <h4 class="alert-heading">**Exemple d'un dataset-descriptor**</h4>
  <p>`r linkAlertCSS("dataset-descriptor-piezo-infra-journalier.xml","https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/raw/Developpement/SI/app_snot/snot-fluxmeteo-services-impl/src/main/resources/org/cnrs/osuc/snot/dataset/fluxmeteo/impl/hydro/dataset-descriptor-piezo-infra-journalier.xml")`</p>
</div>
...
<div class="alert alert-info" role="alert">
  <h4 class="alert-heading">**Exemple du bean hydro-beans.xml**</h4>
  <p>`r linkAlertCSS("hydro-beans.xml","https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/raw/Developpement/SI/app_snot/snot-fluxmeteo-services-impl/src/main/resources/org/cnrs/osuc/snot/dataset/fluxmeteo/impl/hydro/hydro-beans.xml")`</p>
</div>
...
Il est possible de mettre à jour l'application en fonction **des évolutions mineures** apportées sur le noyau du SI des SOERE (correction de bug). Dans ce cas, il est simplement nécessaire de modifier la version du noyau dans le [pom.xml](https://forge-osuc.cnrs-orleans.fr/projects/sie-sno-tourbiere/repository/revisions/master/raw/Developpement/SI/app_snot/pom.xml) : 

Modifier cette partie avec la nouvelle version : 

```{r, engine = 'xml',class.source='klippy',eval=FALSE}
<kernel.version>1709.09</kernel.version>
```
